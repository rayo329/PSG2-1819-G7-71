...
<petclinic:layout pageName="causes/new">
    <h2>
        Nueva Causa
    </h2>
    <form:form modelAttribute="cause" class="form-horizontal" id="add-cause-form">
        ...
        <div class="form-group has-feedback">
            ...
            <petclinic:inputField label="Meta economica" name="budgetTarget"/>
            <petclinic:inputField label="Organizacion" name="organizationName"/>
